...
def focus_app():
    ...
    if system == "Windows":
        ...
        subprocess.run(["xdotool", "search", "--name", TARGET_APP, "windowactivate"])

def press_key(key):
    """Focus target app then simulate a keypress. key: 'right' or 'left'"""
    system = platform.system()
    ...
    if system == "Windows":
        ...
        keyname = "Right" if key == "right" else "Left"
